        ...
        <form id="form" className="w50 justify-content-center mt-3 needs-validation" onChange={props.handleChange} noValidate>
            ...
            <div className="form-row-group text-center offset-1">
                <div className="form-check-inline col-12  col-sm-5  col-lg-3">
                    <input type="checkbox" className="form-check-input " value={1} name="connessione" defaultChecked={props.dati.connessione==="true"}/>
                    <label className="form-check-label">Connessione Wi-fi</label>
                </div>
                <div className="form-check-inline col-12  col-sm-5 col-lg-3">
                    <input type="checkbox" className="form-check-input" id="riscaldamento" name="riscaldamento" value={1} defaultChecked={props.dati.riscaldamento==="true"}/>
                    <label className="form-check-label" htmlFor="riscaldamento">Riscaldamento</label>
                </div>
                <div className="form-check-inline col-12 col-sm-5 col-lg-3">
                    <input type="checkbox" className="form-check-input" id="cucina" name="cucina" value={1} defaultChecked={props.dati.cucina==="true"}/>
                ...
                <div className="form-check-inline col-12 col-sm-5 col-lg-3">
                    <input type="checkbox" className="form-check-input" id="parcheggio" name="parcheggio" value={1} defaultChecked={props.dati.parcheggio==="true"}/>
                ...
                <div className="form-check-inline col-12 col-sm-5 col-lg-3 p-0">
                    <input type="checkbox" className="form-check-input" id="servizioInCamera" name="servizioInCamera" value={1} defaultChecked={props.dati.servizioInCamera==="true"}/>
                    <label className="form-check-label " htmlFor="servizioInCamera">Servizio in camera</label>
                </div>
                <div className="form-check-inline col-12 col-sm-5 col-lg-3">
                    <input type="checkbox" className="form-check-input" id="navettaAereoportuale" name="navettaAereoportuale" value={1} defaultChecked={props.dati.navttaAereoportuale==="true"}/>
