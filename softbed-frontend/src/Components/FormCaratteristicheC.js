    ...
    return(
        <div className="container">
            ...
            <form className="w50 justify-content-center mt-3">
                ...
                <div className="form-group text-center">
                    <div className="form-check-inline col-12 col-lg-4">
                        <label className="form-check-label" htmlFor="feste">
                            <input type="checkbox" className="form-check-input" id="feste" name="feste" value="something"/>Permesse per feste/eventi
                        </label>
                    </div>
                    <div className="form-check-inline col-12 col-lg-4">
                        <label className="form-check-label" htmlFor="animali">
                            <input type="checkbox" className="form-check-input" id="animali" name="animali" value="something"/>Animali ammessi
                        </label>
                    </div>
                    <div className="form-check-inline col-12 col-lg-4">
