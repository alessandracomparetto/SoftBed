...
function Registrazione() {
            ...
            customUI: ({ onClose }) => {
                return (
                    <div className="custom-ui text-center">
                        <h3>Questa email risulta già in uso!</h3>
                        {/* TODO: onClick action */}
                        <button className="btn btn-secondary px-3 py-2 m-2 minw-200px" onClick={onClose}>Riprova</button>
    ...
    function onSubmit(e){
        ...
        if(form.checkValidity()){
            ...
            try {
                axios.post("/user/utenteRegistrato", utenteRegistrato)
                    .then((res) => {
    ...
    return(
        <div className="container">
            <div className="empty-pre-signup"/>
            <div className="col rounded shadow bg-light mx-auto signup border border-warning">
                ...
                <div className="text-center mt-5 pt-3 text-dark"><h3>Registrati</h3></div>
                <form className="mb-4" id="form" noValidate onSubmit={onSubmit} action="/registrati">
                    ...
                    <div className="d-flex justify-content-center mt-4">
                        <button id="ok" type="submit" className="btn btn-primary btn btn-warning rounded-pill text-dark minw-200px">Registrati</button>
                    </div>
                </form>
            </div>
            <div className="empty-post-signup"/>
        </div>
    );
}
