    ...
    return(
        <div className="col-12 col-md-3">
            ...
            <nav className="navbar bg-warning">
                <button className="btn-block navbar-toggler mb-1 text-center" type="button" data-toggle="collapse" data-target="#menu">
                    <span className="d-inline d-md-none d-lg-inline mr-2 ">La mia home</span>
