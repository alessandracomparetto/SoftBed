            ...
            <div className={"mt-3 pt-3 border-top border-dark" + ((mostraContenuto) ? "" : " collapse")}>
                <div className="row mb-3">
                    ...
                    <div className="col-12 col-md-3">
                        <button id ="button" type="button" className="btn btn-danger btn-block mt-3" disabled={props.idospite !== undefined} onClick={() => props.eliminaOspite(props.indiceElemento)}>Elimina</button>
                    </div>
                </div>
