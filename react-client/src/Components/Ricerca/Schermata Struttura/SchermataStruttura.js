        ...
        <div className="container px-3 mt-3">
            ...
            <div className="shadow mt-3 card bg-white p-3">
                ...
                <Breadcrumb gerarchia={[
                    {url: "/cerca?destinazione=" + struttura.localita.regione, testo: struttura.localita.regione},
                    {url: "/cerca?destinazione=" + struttura.localita.provincia, testo: struttura.localita.provincia},
                    {url: "/cerca?destinazione=" + struttura.localita.comune, testo: struttura.localita.comune},
                    ...
                    <form className="form" id="formRichiestaPrenotazione" onSubmit={controlloForm}>
                        ...
                        { struttura.tipologia && struttura.tipologia === "B&B" && struttura.camere && (
                            <div className="my-3">
                                ...
                                { struttura.camere.map((camera) => {
                                    return (
                                        <Fragment key={camera.tipologiacamera}>
                                            <div className="form-group row">
